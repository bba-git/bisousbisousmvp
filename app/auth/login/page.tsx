  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      if (error.message.includes('Email not confirmed')) {
        setError(
          <>
            Veuillez confirmer votre email avant de vous connecter. Vérifiez votre boîte de réception (et les spams).<br />
            <button
              onClick={async () => {
                ...
                if (error) {
                  ...
                  setError('Un nouvel email de vérification a été envoyé. Veuillez vérifier votre boîte de réception.');
                }
              }}
